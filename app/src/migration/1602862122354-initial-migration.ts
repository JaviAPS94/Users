...
export class initialMigration1602862122354 implements MigrationInterface {
    name = 'initialMigration1602862122354'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `shipping_address` (`id` int NOT NULL AUTO_INCREMENT, `nickname` varchar(255) NOT NULL, `zone` json NOT NULL, `country` json NOT NULL, `city` json NOT NULL, `sector` json NOT NULL, `default` tinyint NOT NULL, `lat` decimal(16,13) NULL, `lng` decimal(16,13) NULL, `mainStreet` varchar(255) NOT NULL, `number` varchar(255) NOT NULL, `secondaryStreet` varchar(255) NOT NULL, `addressReference` varchar(255) NOT NULL, `livingPlace` json NULL, `contactPhoneNumber` varchar(255) NULL, `validated` tinyint NOT NULL, `zipCode` varchar(255) NULL, `externalId` varchar(255) NULL, `createdAt` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `deleteAt` timestamp(6) NULL, `userId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `billing_data` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(255) NULL, `address` varchar(255) NULL, `default` tinyint NULL, `document` varchar(255) NULL, `documentType` enum ('CI', 'RUC', 'PASSWORD') NULL, `nickname` varchar(255) NULL, `additionalInfo` json NULL, `email` varchar(255) NULL, `phone` varchar(255) NULL, `externalId` varchar(255) NULL, `createdAt` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `deleteAt` timestamp(6) NULL, `userId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
